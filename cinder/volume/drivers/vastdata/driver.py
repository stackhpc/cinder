...
class VASTVolumeDriver(driver.BaseVD):
    ...
    def ensure_export(self, context, volume):
        ...
        This method verifies that the specified volume exists.
        """
    ...
    def delete_snapshot(self, snapshot):
        """Deletes a snapshot."""
        self.rest.snapshots.delete(name__endswith=snapshot.id)
